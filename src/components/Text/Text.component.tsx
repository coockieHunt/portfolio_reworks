...
export const AccentTextComponent = ({ children, className }: IAccentTextComponentProps): JSX.Element => {
...
export const GradientTextContainer = ({ children, style }: IGradientTextContainerProps & { style?: React.CSSProperties }): JSX.Element => {
    ...
    const gradientColors = useMemo(() => {
        const colorConfig = COLOR_SETTING[currentTheme] || COLOR_SETTING.default;
