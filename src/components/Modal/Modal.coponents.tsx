 ...
 */
const ModalItem = ({ modal, index, onClose }: IModalItemProps): JSX.Element => {
    ...
    return (
        <>
            ...
            >
                ...
                <Content $light={modal.light || 'dark'}>
...
export const ModalComponent = ({ modals, onClose }: IModalComponentProps): JSX.Element => {
