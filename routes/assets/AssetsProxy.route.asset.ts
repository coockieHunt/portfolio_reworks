...
// Proxy image from local assets with folder as param
...
// Proxy image from local assets (folder via query param)
...
// Proxy image from local assets with size (resize using sharp)
